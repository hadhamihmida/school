           ...
           <table id="myTable" class=" table table-striped table-bordered" style="width: 70%">
                            <thead>
                                <tr>
                                   ...
                                   <th style="font: size 13px">email_PA</th>
                                   <th style="font: size 13px">nom_PA</th>
                            ...
                            <tr class="">
                                    <td>{{ $key+1 }}</td>
                                     ...
                                     <td>{{ $data->adresse_el }}</td>
                                     <td>{{ $data->classe }}</td>
                                     <td>{{ $data->parent->nom_pr.''.$data->parent->prenom_pr }}</td>
                                     <td><a href="{{(!empty($data->image))?url('upload'.$data->image):url('upload/no_images.png')}}">
                                 <img src="{{(!empty($data->image))?url('upload'.$data->image):url('upload/no_images.png')}}" style="width: 150px; height:160px; border:1px solid #000;"></a></td>
